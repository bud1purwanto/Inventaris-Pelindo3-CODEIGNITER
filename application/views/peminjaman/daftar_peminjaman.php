              ...
              <table id="example3" class="table border-transparent">
                ...
                <tr class='clickable-row' data-href='<?php echo site_url('inventaris/detail_inventaris/').$key->kd_barang.'/active/fade/fade'?>'>
                  ...
                  <td class="text-center">
                    <a class="btn btn-warning" href="<?php echo site_url('peminjaman/konfirmasi_kembali/').$key->id_peminjaman."/".$key->kd_barang."/".$key->id_ruangan ?>">
                    <!-- onClick="return confirm('Ingin mengembalikan inventaris yang dipinjam?')" -->
