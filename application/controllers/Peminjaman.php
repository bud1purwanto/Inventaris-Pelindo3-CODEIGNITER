...
class Peminjaman extends CI_Controller{
  ...
  function konfirmasi_Kembali()
  {
    $title['title'] = "Cek Kondisi";

		$this->form_validation->set_rules('detail_kondisi', 'Detail Kondisi', 'required');

		if ($this->form_validation->run()==FALSE) {
			$this->load->view('global/01_header', $title);
			$this->load->view('peminjaman/konfirmasi_Kembali', $data);
		} else {
		    ...
		    $this->Inventaris_Model->editKondisiInventarisDiKembalikan($kd_barang);
